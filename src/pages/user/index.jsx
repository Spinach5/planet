    ...
    <SafeAreaView>
      ...
      <View className='container'>
        ...
        <View className='bora card list'>
          <View className='item' onClick={manage_account}><Text>账号管理</Text></View>
        </View>

        <View className='bora card list'>
          <View className='item' onClick={showLocalImage}><Text>向我们反馈</Text></View>
          <View className='item' onClick={showLocalImage}><Text>加入我们</Text></View>
        </View>

        <View className='bora card'>
          <View className='item' onClick={get_course_data}>
            <View><Text>从xxt获取课表</Text></View>
          </View>
          <View className='item' onClick={handleLogout}>
            <View><Text style={{ color: 'red' }}>清除所有小程序缓存</Text></View>
            <View><Text className='descript'>同时将会清除登录状态</Text></View>
          </View>
        </View>
      </View>
